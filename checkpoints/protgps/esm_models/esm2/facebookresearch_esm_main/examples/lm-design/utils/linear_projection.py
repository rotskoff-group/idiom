...
def extract_features(
    ...
    return emb[:, out_start_idx:out_end_idx], attentions[
        :, :, out_start_idx:out_end_idx, out_start_idx:out_end_idx
    ]
...
class LinearProjectionDistogramModel(nn.Module):
    ...
    def forward(self, src_tokens, **kwargs):
        _, attentions_asym = extract_features(
            self.base_model, src_tokens, need_head_weights=True
        )
