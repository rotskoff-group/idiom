"""
Make prompts for generating IDPs (prompt is just '132')
"""
...
# shard = '/home/scratch_mount/group_scratch/idr_plm/sherlock_rsync/AFDB/AFDB_v4_idr_alldata/clustering/AFDB_IDR_90/AFDB_IDR_90_splits/AFDB_IDR_90_FIM_512_splits/AFDB_IDR_90_FIM_512_splits_parts/precompute_shards/0001_file.h5' # 4080 splits
...
num_duplicates = 1000
header = f"{acc.lower()}_prompt_1e3x"
...
print(f"Saved protein prompts to {out_dir}")
...
# # Load prompt_array
# with open(os.path.join(out_dir, array_filename), 'rb') as f:
#     loaded_prompt_array = pickle.load(f)

# # Load metadata
# with open(os.path.join(out_dir, metadata_filename), 'rb') as f:
