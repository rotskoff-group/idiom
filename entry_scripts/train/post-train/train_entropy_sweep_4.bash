...
# FIM10 is version_2 
CKPT_PATH="/home/scratch/group_scratch/idr_plm/102425OnlineERADebugging/lightning_logs/version_0/checkpoints/best_model_step_247865.ckpt"

SHARD_PATH="/home/scratch/group_scratch/idr_plm/102425OnlineERADebugging/dataset/0001_file.h5"
...
mgpt_transformer_train \
            "data=transformer"\
            "data.dataset=TransformerOnlineDataset"\
            "data.collate_fn=transformer_online_collate_fn"\
            "data.dataset_filename=dataset/idp_prompt_1000x_grpo_dataset.h5"\
            ...
            "++training.trainer_args.limit_val_batches=0"\
            ...
            "++training.lightning_model_args.protgps_parent_dir=/home/jxliu2/protgps"\
...
echo ""
echo "Completed TARGET_LENGTH=${TARGET_LENGTH}, COMPARTMENT=${COMPARTMENT}"
echo "ENTROPY_REWARD_WEIGHT=${ENTROPY_REWARD_WEIGHT}, TARGET_ENTROPY=${TARGET_ENTROPY}"
echo ""
