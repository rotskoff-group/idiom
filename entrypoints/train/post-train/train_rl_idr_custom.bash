#!/bin/bash
#SBATCH --job-name=rl_idr
#SBATCH --time=1-00:00:00
#SBATCH --gpus=1
#SBATCH --cpus-per-task=1
#SBATCH --output=./slurm_out/slurm-%j.out

# You can run this script using 'sbatch train_rl_idr_custom.bash' or 'bash train_rl_idr_custom.bash'
...
###
# Combined script: Make IDR RL dataset then run GRPO training with a custom reward function
###
...
echo "======================================================================"
echo "Running with TARGET_LENGTH=${TARGET_LENGTH}"
...
transformer_train \
    ...
    "++training.lightning_model_args.reward_function_name=compute_fraction_proline"\
