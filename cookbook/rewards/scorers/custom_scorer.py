...
Implement build() to return a batch scorer. _scorer_protocol.serve handles JSON I/O;
return one finite score per input sequence. See cookbook/rewards/README.md.
"""
