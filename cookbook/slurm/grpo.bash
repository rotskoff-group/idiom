...
idiom_grpo \
    ...
    reward.module=null \
    reward.terms='[{reward: entropy, weight: 1.0, shaping: {type: quadratic, target: 3.65, width: 0.2}}, {reward: length, weight: 1.0, shaping: {type: quadratic, target: 100, width: 1.0}}, {reward: sae_only_nucleolus, module: ${idiom_rewards:rl_sae_reward/rl_sae_reward.py}, weight: 1.0}]' \
